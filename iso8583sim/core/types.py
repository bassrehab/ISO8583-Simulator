...
ISO8583_FIELDS: Dict[int, FieldDefinition] = {
    ...
    0: FieldDefinition(
        ...
        max_length=4,
        description="Message Type Indicator (MTI)",
        padding_char=None
    ),
    2: FieldDefinition(
...
VERSION_SPECIFIC_FIELDS = {
    ...
    ISO8583Version.V1993: {
        ...
        54: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=255,
            description="Additional Amounts (1993)",
            padding_char=None
        ),
        55: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=255,
            description="ICC System Related Data (1993)",
            padding_char=None
        ),
    },
    ...
    ISO8583Version.V2003: {
        ...
        54: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=512,
            description="Additional Amounts (2003)",
            padding_char=None
        ),
        55: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=999,
            description="ICC System Related Data (2003)",
            padding_char=None
        ),
        56: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=999,
            description="Original Data Elements (2003)",
            padding_char=None
        ),
        57: FieldDefinition(
            field_type=FieldType.LLLVAR,
        ...
        59: FieldDefinition(
            field_type=FieldType.LLLVAR,
            max_length=999,
            description="Transport Data (2003)",
            padding_char=None
        ),
    }
}
